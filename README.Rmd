...
`r icon_style(simple_icons("gmail"), scale=2, fill="red")`: graflukas57@gmail.com 

`r icon_style(simple_icons("twitter"),scale=2, fill="#1DA1F2")`: https://twitter.com/graf_gruen 
